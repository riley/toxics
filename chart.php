<html>
  <head>
	...
	<script type="text/javascript" src="js/albers.js"></script>
...
var data = {
	<?php 
	$counter = 0;
	foreach($pollution as $state => $amount) {
		$counter++;
		$comma = ($counter == count($pollution)) ? '' : ',';
		echo "$state: $amount" . $comma . "\n";
	}
	?>
}
</script>
...
/*var scale = pv.Geo.scale()
	...
	var scale = pv.Geo.scale(albers(23, -96, 29.5, 45.5)).range({ x: -365, y: -375 }, { x: 1200, y: 1200 });
